...
const SelectCategory = () => {
  const [selectCategory, setSelectCategory] = useState(categoryList[0].name);
              ...
              <span>
                <button
                  className={`OKHdJ z Pc PQ Pp PD W _S Gn Rd _M xARtZ uPlAb hzzSG PQFNM wSSLS ${
                    selectCategory === category.name && 'yTAho'
                  }`}
                  type="button"
                ...
                >
                  <div className="RCAPL j u">
                    <span className="Ni">{category.icon}</span>
                    <span className="biGQs _P FvqAl FGgoA vvmrG">
                      <div className="biGQs _P ttuOS">{category.name}</div>
                    </span>
                  </div>
                </button>
              </span>
