const Section1 = () => {
  return (
    <div class="IDaDx Iwmxp mvTrV cyIij fluiI SMjpI">
      <div class="f k O Cj Pj PN Pw PA">
        <div data-automation="breadcrumbs" class="Nm">
          <div class="KCGqk _T Cj">
            <a
              href="/Tourism-g2-Asia-Vacations.html"
              class="BMQDV _F Gv wSSLS SwZTJ EabUM FGwzt ukgoS"
            >
              <span class="n q">
                <span class="biGQs _P pZUbB avBIb osNWb">Châu Á</span>
              </span>
            </a>
            <span class="OQDkj y S0 c">
              <svg
                viewBox="0 0 24 24"
                width="1em"
                height="1em"
          ...
          <div class="KCGqk _T Cj">
            <a
              href="/Tourism-g293921-Vietnam-Vacations.html"
              class="BMQDV _F Gv wSSLS SwZTJ EabUM FGwzt ukgoS"
            >
              <span class="n q">
                <span class="biGQs _P pZUbB avBIb osNWb">Việt Nam</span>
              </span>
            </a>
            <span class="OQDkj y S0 c">
              <svg
          ...
          <div class="KCGqk _T Cj">
            <a href="" class="BMQDV _F Gv wSSLS SwZTJ EabUM FGwzt ukgoS">
              <span class="n q">
                <span class="biGQs _P pZUbB avBIb osNWb">Hà Nội</span>
              </span>
              <span class="OQDkj y S0 c">
                <svg
                  viewBox="0 0 24 24"
            ...
            >
              ...
              >
                ...
                <a href="/Restaurants-g293924-Hanoi.html" class="fKngU _S R4 b">
              ...
              >
                ...
                >
                  <a
                    href="/HotelsNear-g667465-d4142559-Bogra_Station-Bogra_Rajshahi_Division.html"
                    class="fKngU _S R4 b"
                  >
                    Khách sạn ở gần Bogra Station
                  </a>
                </div>
                <a class="fKngU _S R4 b razWA">
                  Sân bay ở gần
              ...
              <a href="/Articles" class="fKngU _S R4 b">
                Câu chuyện du lịch
              </a>
              <a href="/Cruises" class="fKngU _S R4 b">
              ...
              >
                ...
                <a href="/AddListing" class="fKngU _S R4 b">
                  Thêm địa điểm
                </a>
                <a href="/Airlines" class="fKngU _S R4 b">
                  Hãng hàng không
                </a>
                <a href="/TravelersChoice" class="fKngU _S R4 b">
                  Travellers' Choice
                </a>
                <a
                ...
                <a href="/Trips" class="fKngU _S R4 b">
        ...
        <h1 data-automation="masthead_h1" class="Wi _m H0">
          <div class="biGQs _P pZUbB avBIb osNWb">Du lịch Hà Nội</div>
        </h1>
      </div>
    </div>
  );
